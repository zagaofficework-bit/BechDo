...
const SkeletonCard = memo(() => (
  <div style={{
    ...
    <div style={{ height: 180, background: "linear-gradient(135deg, #f0f6fb 0%, #e4eef7 100%)" }} />
...
// ─── Nearby product card ──────────────────────────────────────────────────────
const NearbyCard = memo(({ product, onClick }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "14px 14px 16px" }}>
        ...
        {/* Title */}
        <h3 style={{
          fontSize: 13, fontWeight: 600, color: "#0f2a3d",
        ...
        {product.address?.city && (
          <p style={{
            fontSize: 11, color: "#8faab8", margin: "0 0 9px",
        ...
        <div style={{ display: "flex", alignItems: "baseline", gap: 7, marginBottom: 9 }}>
          <span style={{
            fontSize: 18, fontWeight: 800, color: "#0077b6",
            letterSpacing: "-0.02em",
          }}>
            ₹{fmt(product.price)}
          </span>
          {product.originalPrice && (
            <span style={{ fontSize: 11, color: "#b0c4ce", textDecoration: "line-through", fontWeight: 500 }}>
        ...
        {/* Divider */}
        <div style={{ height: 1, background: "#f0f5f9", marginBottom: 9 }} />
...
export default function NearbyDevices({ radius = 10 }) {
  ...
  const canNext = index < products.length - VISIBLE;

  const handlePrev = useCallback(() => setIndex(i => Math.max(0, i - 1)), []);
  const handleNext = useCallback(() => setIndex(i => Math.min(products.length - VISIBLE, i + 1)), [products.length]);
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 7, marginBottom: 6 }}>
                <div style={{ position: "relative", width: 10, height: 10, flexShrink: 0 }}>
                  <div style={{
                    ...
                    background: location ? "#0077b6" : "#cbd5e1",
                  }} />
                  {location && (
                    <div style={{
              ...
              <h2 style={{
                fontSize: 26, fontWeight: 800, color: "#0f2a3d",
                margin: "0 0 5px", letterSpacing: "-0.025em", lineHeight: 1.1,
              }}>
                Devices in Your Area
              </h2>
              <p style={{ fontSize: 13, color: "#8faab8", margin: 0, fontWeight: 500 }}>
                {location
              ...
              {showProducts && (
                <button
                  ...
                  style={{
                    ...
                    fontSize: 13, fontWeight: 700, color: "#0077b6",
                  ...
                  onMouseLeave={e => {
                    ...
                    e.currentTarget.style.borderColor = "rgba(0,119,182,0.18)";
                  }}
                >
                  View all
          ...
          {showPrompt && (
            <div style={{
              ...
              <div style={{
                ...
                <svg width="22" height="22" fill="none" stroke="#0077b6" strokeWidth="2" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                </svg>
              </div>
              <div style={{ flex: 1, minWidth: 180 }}>
                <p style={{ fontSize: 14, fontWeight: 700, color: "#0f2a3d", margin: "0 0 4px" }}>
                  Find devices near your location
                </p>
                <p style={{ fontSize: 12, color: "#8faab8", margin: 0, lineHeight: 1.5 }}>
                  See refurbished phones, laptops and more being sold close to you
                </p>
              </div>
              <button
                ...
                style={{
                  ...
                  opacity: locLoading ? 0.75 : 1,
                  transition: "all 0.18s ease", flexShrink: 0, outline: "none",
                  fontFamily: "'Outfit', sans-serif",
                  boxShadow: "0 4px 16px rgba(0,119,182,0.28)",
                }}
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer", fontSize: 12, flexShrink: 0, outline: "none",
                  fontFamily: "'Outfit', sans-serif",
                }}
              >
                Retry
          ...
          {/* ── Loading skeletons ── */}
          {loading && (
            <div style={{ display: "flex", gap: CARD_G, overflow: "hidden" }}>
          ...
          {showEmpty && (
            <div style={{ textAlign: "center", padding: "56px 0" }}>
              ...
              <p style={{ fontSize: 14, fontWeight: 600, margin: "0 0 6px", color: "#4a7c99" }}>
                No devices found within {radius}km
              </p>
              <p style={{ fontSize: 12, margin: 0, color: "#8faab8" }}>
            ...
            <div style={{ overflow: "hidden" }}>
              <div
                ...
                style={{
                  ...
                  transform: `translateX(-${index * (CARD_W + CARD_G)}px)`,
                }}
              >
                {products.map((p, i) => (
                  <NearbyCard
